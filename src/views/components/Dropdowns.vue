	...
	<div class="col-12 col-md-8 order-md-1 col-lg-7 offset-lg-1 py-5" id="nav-scroller" ref="content">
	    ...
	    <div class="row">
	        ...
	        <div class="col-12 col-lg-10 titles-ct mt-0">
	            <h1>Dropdowns</h1>
	            <h2>Dropdowns are toggleable, contextual overlays for displaying lists of links and actions in a dropdown menu format.</h2>
	        </div>
	        <!-- / Title Container-->
	        <div class="col-12">
	            <hr>
	        ...
	        <!-- Page description text -->
       		<div class="col-12 text-justify">
            	<p><code>&lt;b-dropdown&gt;</code> (or known by its shorter alias of <code>&lt;b-dd&gt;</code>) components are toggleable,
