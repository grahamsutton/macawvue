	...
	<div class="col-12 col-md-8 order-md-1 col-lg-7 offset-lg-1 py-5" id="nav-scroller" ref="content">
	    ...
	    <div class="row">
	        ...
	        <div class="col-12 col-lg-10 titles-ct mt-0">
	            <h1>Lists</h1>
	            <h2>List groups are a flexible and powerful component for displaying a series of content. List group items can be modified to support just about any content within. They can also be used as navigation via various props.</h2>
	        </div>
	        <!-- / Title Container-->
	        <div class="col-12">
	            <hr>
